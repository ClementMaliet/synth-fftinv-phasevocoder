...
%-------------------------------------------------------
\centering{In this case, the phase changing is different from the stationary case:}
\\
\centering{We have to calculate the instantaneous frequency for the kth bin:}
...
%-------------------------------------------------------
%code pour mettre les images c�te � c�te
\begin{figure}
...
%-------------------------------------------------------
\begin{itemize}
\item The idea is the same as for the stationary case, except that we have to deal with the phase locking:
\begin{figure}
      \includegraphics[scale=0.5]{phaselocking.png}
      \caption{\it Phase-locking scheme}
