...
\author[Clément Cazorla - Vincent Chrun - Bastien Fundaro - Clément Maliet]
...
\institute[ENSEEIHT]
{
	     ...
	     \includegraphics[scale = 0.15]{Feathergraphics/agn7.png}
	\centering\\
...
%-------------------------------------------------------
  ...
  \begin{itemize}
    \item<1-> We are continuing the 2015 project ...
  \end{itemize}
\end{frame}
...
%-------------------------------------------------------
  ...
  \begin{itemize}
    \item<1-> We need to ... with an already given "analysis" code/methods
  \end{itemize}
\end{frame}
