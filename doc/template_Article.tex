...
\_gen\_lobe is an abstract class called either in StationaryLobeGenerator or in NonStationaryLobeGenerator that generates the. Both methods will be more explained in the following paragraphs.
