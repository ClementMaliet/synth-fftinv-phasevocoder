...
In signal processing, about as much work has been done in analysing sounds as in synthesizing them. The most common approach is to assimilate the sound to a sum of time varying sinusoids, which are called partials \cite{quatieri2002audio}:
\begin{equation}\label{additiveSynthesis}
