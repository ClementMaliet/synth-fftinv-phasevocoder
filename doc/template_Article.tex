...
\\
Indeed, we can consider that the noise can be neglected compared to the periodic par of the signal which is assumed to be a linear combination of sinusoids. Besides, we consider that the sinusoids are stationary, that is to say that the parameters are assumed to be stationary over time.
...
For the details, please refer to paper\cite{karrer2006phavorit} where the algorithm is well detailed.
