...
An interesting thing to do would be to get a real \textbf{analysis} method to get the parameters from a real sound signal and then to listen to the synthesised sound. Because without an analysis tool, we cannot really test our synthesis method.
